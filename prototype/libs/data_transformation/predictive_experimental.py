"""
File name: predicitive_experimental.py
Author: Lukas Morong, xmoron01
Year: 2023
Description: Python prototype implementation of predictive compression with experimental predictor
            It contains support function for sine regression, sine mixing, weighting function
            diff function which calculates prediction error, sine generators
"""
