 ...
 * Year: 2023
 * Description: 
 *     Rice golomb dekodovanie, s optimalizaciou parametru
 */
...
int c_entry(){
    ...
    uint8_t i_divider = find_optimal(i_samples);
    uint8_t q_divider = find_optimal(q_samples);
    print_uart0_int(i_divider);
    print_uart0("\n");
    print_uart0_int(q_divider);
    print_uart0("\n");
    golomb_encode(i_samples, i_divider, true);
    golomb_encode(q_samples, q_divider, true);
